...
def icp(A, B, init_pose=None, match_all=False, dist_thresh=1.0,
    ...
    for i in range(max_iterations):
        ...
        T,_,_ = best_fit_transform(src_match, dst_match)
        ...
        if np.abs(prev_error - mean_error) < tolerance and i > 5:
            break
